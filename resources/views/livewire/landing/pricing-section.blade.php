    ...
    <div class="max-w-[1200px] mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="reveal opacity-0 translate-y-6 transition-all duration-500 [&.visible]:opacity-100 [&.visible]:translate-y-0 bg-white border border-black/5 border-[length:1.5px] rounded-2xl p-9 relative transition-all hover:-translate-y-1.5 hover:shadow-[0_24px_60px_rgba(42,165,189,0.13)]">
                <div class="text-[0.76rem] font-bold tracking-widest uppercase text-[#2AA5BD] mb-2.5">Available Now</div>
                <div class="text-2xl font-black text-[#0b1f26] mb-5">Free Trial</div>
                <div class="flex items-baseline gap-1 mb-1">
                    <span class="font-mono text-[0.88rem] text-[#2AA5BD]">TZS</span>
                    <span class="font-[family-name:var(--font-playfair)] text-[3rem] font-black text-[#0b1f26] leading-none">0</span>
                </div>
                <div class="text-[#6a8e99] text-[0.84rem]">per month</div>
                <div class="text-[#6a8e99] text-[0.84rem] my-2.5 mb-6">Start immediately at no cost. Full access while we are in free-trial mode.</div>
                ...
                <a href="{{ route('register') }}" class="block w-full py-3 rounded-[10px] border border-black/5 border-[length:1.5px] bg-transparent text-[#1e3a44] font-semibold text-[0.9rem] text-center hover:border-[#2AA5BD] hover:text-[#2AA5BD] transition-all no-underline">Start Free Trial</a>
            </div>
            ...
            <div class="reveal opacity-0 translate-y-6 transition-all duration-500 [&.visible]:opacity-100 [&.visible]:translate-y-0 bg-white border-2 border-[#2AA5BD] rounded-2xl p-9 relative transition-all bg-gradient-to-b from-[rgba(42,165,189,0.06)] to-white hover:-translate-y-1.5 shadow-[0_16px_48px_rgba(42,165,189,.14)]">
                <div class="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-[#2AA5BD] text-white py-1 px-4 rounded-full text-[0.72rem] font-bold tracking-wider uppercase whitespace-nowrap shadow-[0_4px_12px_rgba(42,165,189,.4)]">Coming Soon</div>
                ...
                <div class="flex items-baseline gap-1 mb-1">
                    <span class="font-mono text-[0.88rem] text-[#2AA5BD]">TZS</span>
                    <span class="font-[family-name:var(--font-playfair)] text-[3rem] font-black text-[#0b1f26] leading-none">9K</span>
                </div>
                <div class="text-[#6a8e99] text-[0.84rem]">per month</div>
                ...
                <a href="#" class="block w-full py-3.5 rounded-[10px] bg-[#d1dce0] text-[#6a8e99] font-bold text-[0.9rem] text-center no-underline cursor-not-allowed">Coming Soon</a>
            </div>
            {{-- Business+ --}}
            <div class="reveal opacity-0 translate-y-6 transition-all duration-500 [&.visible]:opacity-100 [&.visible]:translate-y-0 bg-white border border-black/5 border-[length:1.5px] rounded-2xl p-9 relative transition-all hover:-translate-y-1.5 hover:shadow-[0_24px_60px_rgba(42,165,189,0.13)]">
                ...
                <div class="flex items-baseline gap-1 mb-1">
                    <span class="font-mono text-[0.88rem] text-[#2AA5BD]">TZS</span>
                    <span class="font-[family-name:var(--font-playfair)] text-[3rem] font-black text-[#0b1f26] leading-none">15K</span>
                </div>
                <div class="text-[#6a8e99] text-[0.84rem]">per month</div>
                ...
                <a href="#" class="block w-full py-3 rounded-[10px] border border-[#d1dce0] border-[length:1.5px] bg-transparent text-[#9bb2ba] font-semibold text-[0.9rem] text-center no-underline cursor-not-allowed">Coming Soon</a>
            </div>
        </div>
